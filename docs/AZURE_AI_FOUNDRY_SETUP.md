...
4. **Azure AI Foundry Resource** deployed:
   - SKU: Standard (S0)
...
The ClassyMail MVP requires the following model deployments in Azure AI Foundry:
...
1. Navigate to [Azure AI Foundry](https://ai.azure.com) or use Azure Portal
...
7. Note: MaaS deployments are pay-per-use, no TPM allocation needed
...
|----------|-------|---------|
| `AI_ENDPOINT` | Azure AI Foundry endpoint URL | `https://swedencentral.api.cognitive.microsoft.com/` |
...
| `MISTRAL_DEPLOYMENT` | Mistral deployment name | `mistral-document-ai-2505` |
...
mistral-document-ai-2505       Mistral-Large      2505
...
- [ ] Application Insights shows model telemetry
...
5. Consult [Azure AI Foundry documentation](https://learn.microsoft.com/azure/ai-studio/)
