...
1. Go to [Microsoft AI Foundry](https://ai.azure.com/)
...
### 5.1 Open Microsoft AI Foundry



1. Go to [Microsoft AI Foundry](https://ai.azure.com/)

2. Select your project: `classymail-dev-project`
...
> **Rating**: The UI dynamically fetches available deployments from `/api/admin/deployments`.
...
| Mistral deployment fails | Model not available in region | Check model catalog in Microsoft AI Foundry; try `swedencentral` or `eastus`. See [Section 1.4](#14-verify-mistral-document-ai-availability) |
