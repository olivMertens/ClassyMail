...
| Azure AI Foundry | `classymail-dev-aifoundry` |
...
| **Mistral Document AI 2505** | `mistral-document-ai-2512` | Global Standard | ✅ (US + EU) | All regions (Global Standard) ¹ | OCR / PDF extraction |
