...
- **Current State**: Mistral Document AI (`mistral-document-ai-2512`) already analyzes images within the PDF and describes them in the Markdown output (e.g., `![Image: Logo of AXA Assurance]`).
