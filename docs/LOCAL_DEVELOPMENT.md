...
MISTRAL_DEPLOYMENT=mistral-document-ai-2512  # ?? CRITICAL: Must be EXACTLY this name ï¿½ typos cause HTTP 500 errors
MISTRAL_MODE=maas
...
- [SCENARIO_E2E.md](SCENARIO_E2E.md) - End-to-end testing
