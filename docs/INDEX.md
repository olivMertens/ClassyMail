...
- [INTEGRATION](INTEGRATION.md) - Preprocessing avancé, slugs, export CSV (**ClassyMail-specific**)
- [CUSTOMIZATION](CUSTOMIZATION.md) - **Configuration ClassyMail** : tags, catégories assurance, branding, policy Azure
