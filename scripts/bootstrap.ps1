...
# Models: deploy manually via Microsoft AI Foundry portal
...
Write-Host "  Deploy AI models in Microsoft AI Foundry:" -ForegroundColor Yellow
...
Write-Host "       - mistral-document-ai-2512 (MaaS) <- OCR" -ForegroundColor White
