...
<template>
  <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-75 p-4 sm:p-0">
    <div
          ...
          <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
            ...
            <div class="mt-4 text-sm text-gray-600 dark:text-gray-300">
              ...
              <p class="mt-2">
                ...
                <a href="mailto:olmertens@microsoft.com"
                  class="text-primary-600 dark:text-primary-400 hover:underline">olmertens@microsoft.com</a>
              </p>
      ...
      <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:flex sm:items-center sm:justify-between sm:px-6">
