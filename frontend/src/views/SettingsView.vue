                    ...
                    <li v-for="(cat, idx) in settings.categories" :key="idx" class="py-4">
                        <div class="flex items-start justify-between">
                            <div class="min-w-0 flex-1 mr-4">
                                <p class="text-sm font-bold text-gray-900 dark:text-white">{{ cat.name }}</p>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 whitespace-pre-wrap">{{ cat.description }}</p>
                            </div>
            ...
            <div class="mt-8 bg-gray-50 dark:bg-gray-700/30 p-4 rounded-md border border-gray-200 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                    <div class="sm:col-span-2">
                        ...
                        <div class="mt-1">
                            <input v-model="(isEditing ? editingCategory : newCategory).name" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 dark:bg-gray-800 dark:text-white dark:ring-gray-600" placeholder="e.g. Contract Cancellation">
                        </div>
                    </div>
