    ...
    >
      <div class="px-4 py-5 sm:p-6">
        ...
        <div class="rounded-lg border border-gray-200 dark:border-gray-700 p-5 mb-6 bg-gray-50/50 dark:bg-gray-900/20">
          ...
          <div
            v-if="!['gpt-4o', 'gpt-4o-mini', 'gpt-4.1-nano'].includes(settings.ai_model)"
          ...
          <div
            v-else
            class="mt-2 flex items-center gap-2 text-green-600 dark:text-green-400 text-sm"
          >
              ...
              <div class="ml-3 flex-1 text-sm">
                ...
                <div class="text-blue-700 dark:text-blue-200 space-y-1">
                  ...
                  >
                    ...
                    <div class="flex gap-2 shrink-0">
                      ...
                      <span
                        v-if="settings.adversarial_model === m.key"
                ...
                >
                  ...
                  <ul class="list-disc pl-4 space-y-0.5">
                    ...
                    <li><strong>Adversarial comparison:</strong> doubles classification calls (~×2 cost)</li>
                    <li><strong>Reprocessing:</strong> multiplies ALL above by number of passes</li>
                  </ul>
                  <p class="italic mt-1">
                    With all features enabled + adversarial: expect ~×3–4 the base estimate.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                v-model="settings.csv_export.unclassified_label"
                type="text"
                class="block w-full max-w-xs rounded-md border-0 py-2.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6 dark:bg-gray-700 dark:text-white dark:ring-gray-600"
                placeholder="autre"
              >
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div class="flex items-center">
                  <input
                    id="export-quality"
                    v-model="settings.csv_export.show_quality"
                    type="checkbox"
                    class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600 dark:bg-gray-700 dark:border-gray-600"
                  >
                  <label
                ...
                <div class="flex items-center">
                  <input
                    id="export-model"
                    v-model="settings.csv_export.show_model"
                    type="checkbox"
                    class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600 dark:bg-gray-700 dark:border-gray-600"
                  >
                  <label
                ...
                <div class="flex items-center">
                  <input
                    ...
                    v-model="settings.csv_export.show_justification"
                    type="checkbox"
                    class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600 dark:bg-gray-700 dark:border-gray-600"
                  >
                  <label
                ...
                <div class="flex items-center">
                  <input
                    ...
                    v-model="settings.csv_export.show_visual_proofs"
                    type="checkbox"
                    class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600 dark:bg-gray-700 dark:border-gray-600"
                  >
                  <label
                ...
                <div class="flex items-center">
                  <input
                    id="export-time"
                    v-model="settings.csv_export.show_time"
                    type="checkbox"
                    class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600 dark:bg-gray-700 dark:border-gray-600"
                  >
                  <label
                ...
                <div class="flex items-center">
                  <input
                    id="export-pii"
                    v-model="settings.csv_export.show_pii"
                    type="checkbox"
                    class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600 dark:bg-gray-700 dark:border-gray-600"
                  >
                  <label
                ...
                <div class="flex items-center">
                  <input
                    ...
                    v-model="settings.csv_export.show_ocr_provider"
                    type="checkbox"
                    class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600 dark:bg-gray-700 dark:border-gray-600"
                  >
                  <label
