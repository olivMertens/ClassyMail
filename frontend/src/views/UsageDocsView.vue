      ...
      <div class="px-4 py-5 sm:p-6">
        ...
        <div class="mt-4 prose dark:prose-invert text-sm max-w-none">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
                <h4 class="font-medium">{{ t('guide.usage.step1_title') }}</h4>
                ...
                <h4 class="font-medium mt-4">{{ t('guide.usage.step2_title') }}</h4>
            ...
            <div>
                <h4 class="font-medium">{{ t('guide.usage.step3_title') }}</h4>
                <p>{{ t('guide.usage.step3_desc') }}</p>

                <h4 class="font-medium mt-4">{{ t('guide.usage.step4_title') }}</h4>
    ...
    <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg px-4 py-5 sm:p-6">
        ...
        <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="border border-gray-200 dark:border-gray-700 rounded p-3">
                <h5 class="font-medium text-sm">{{ t('guide.vision.standard_title') }}</h5>
                <p class="text-xs text-gray-500 mt-1">{{ t('guide.vision.standard_desc') }}</p>
            </div>
            <div class="border border-gray-200 dark:border-gray-700 rounded p-3 bg-amber-50 dark:bg-amber-900/10">
                <h5 class="font-medium text-sm">{{ t('guide.vision.vision_title') }}</h5>
                <p class="text-xs text-gray-500 mt-1">{{ t('guide.vision.vision_desc') }}</p>
            </div>
        </div>
    </div>
  </div>
