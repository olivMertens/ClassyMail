...
- `codebase` â€“ Review existing architecture
- `githubRepo` â€“ Find related discussions and issues
- `web/fetch` â€“ Research best practices and examples
- `vscode` â€“ Check for existing ADRs and numbering
